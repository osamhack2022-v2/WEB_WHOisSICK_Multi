...
export default function ExplainBox() {
    return (
        ...
        <Typography component="div" variant="h6" sx={{fontWeight: 'bold'}} gutterBottom>한 번씩은 필독 바랍니다.</Typography>
        </Grid>
        ...
        <CalendarMonth />
            ...
            sx={{
                ...
                justifyContent: "center",}}>
            <Typography component="div" variant="h6" sx={{fontWeight: 'bold', color: blue[500]}}>캘린더 사용 시</Typography>
        ...
        <LocalHospital />
            ...
            sx={{
                ...
                alignItems: 'flex-start',
                justifyContent: "center",}}>
            <Typography component="div" variant="h6" sx={{fontWeight: 'bold', color: blue[500]}}>해당 진료과 작성 시</Typography>
            <Typography component="div" variant="subtitle1" gutterBottom>
        ...
        <SpatialAudioOff />
            ...
            sx={{
                ...
                alignItems: 'flex-start',
                justifyContent: "center",}}>
            <Typography component="div" variant="h6" sx={{fontWeight: 'bold', color: blue[500]}}>증상 작성 시</Typography>
            <Typography component="div" variant="subtitle1" gutterBottom>
